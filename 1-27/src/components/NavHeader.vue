<template>
    <header class="header">
      <svg style="position: absolute; width: 0; height: 0; overflow: hidden;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <div class="md-modal modal-msg md-modal-transition" :class="{'md-show': lgoinModalFlag}">
          <div class="md-modal-inner">
            <div class="md-top">
              <div class="md-title">Login in</div>
              <button class="md-close" @click="lgoinModalFlag=false">Close</button>
            </div>
            <div class="md-content">
              <div class="confirm-tips">
                <div class="error-wrap">
                  <span class="error error-show" v-show="errorTip">{{loginHint}}</span>
                </div>
                <ul>
        ...
        <div class="md-overlay" v-if="lgoinModalFlag" @click="lgoinModalFlag=false"></div>
    </header>
</template>
<style>
.header {
